using System;
using BackupFolderAzureDurableFunctionDemo.Services.Logging.Serilog.Services;
...
namespace BackupFolderAzureDurableFunctionDemo.Services.Logging.Serilog.Extensions
{
    /// <summary>
